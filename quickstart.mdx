...
<Tip>
  Save these instructions in your editor's system prompt or custom instructions. Most editors have a setting for this in their preferences or AI configuration section.
</Tip>
...
<Card title="Explore the full documentation" icon="book" href="/usage/ai-agent-integration">
  Learn about advanced usage patterns and best practices.
</Card>

<Card title="Check the API reference" icon="code" href="/api/askA24zMemory">
