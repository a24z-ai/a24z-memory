...
import { DEFAULT_REPOSITORY_CONFIG, DEFAULT_PATH_CONFIG } from '../../pure-core/config/defaultConfig';
import {
...
import { StoredAnchoredNote, AnchoredNoteWithPath } from '../../pure-core/types';

export { TokenLimitInfo } from '../utils/tokenCounter';

// Re-export the types for backward compatibility
export { StoredAnchoredNote, AnchoredNoteWithPath };
