...
async function main() {
  ...
  // Ask with filters
  console.log('❓ Question with Filters: "What security gotchas should I know?"\n');
  ...
  console.log(`    - Tags: ${response2.metadata.filters.tags?.join(', ') || 'none'}`);
  console.log(`    - Types: ${response2.metadata.filters.types?.join(', ') || 'none'}`);
